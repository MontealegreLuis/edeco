...
CREATE TABLE permission (name VARCHAR(45), rolename VARCHAR(15), resourcename VARCHAR(25), PRIMARY KEY(name, rolename, resourcename)) DEFAULT CHARACTER SET UTF8 ENGINE = INNODB;
...
CREATE TABLE resource (name VARCHAR(25), PRIMARY KEY(name)) DEFAULT CHARACTER SET UTF8 ENGINE = INNODB;
