...
abstract class PhpThumb_Base
{
     ...
     * @see PhpThumb_Base::$importedFunctions
     * @return array
     */
	 ...
	 *
	 * @see PhpThumb_Base::$errorMessage
	 */
